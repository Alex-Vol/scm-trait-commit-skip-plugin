...
public class BitbucketCommitMessageBranchBuildStrategy extends CommitMessageBranchBuildStrategy {
    ...
    public BitbucketCommitMessageBranchBuildStrategy(@CheckForNull String pattern) {
        super(pattern);
    }

    @Override
    public String getMessage(SCMSource source, SCMHead head, SCMRevision currRevision)
        ...
        throw new CouldNotGetCommitDataException(
                "Revision class is not a BitbucketGitSCMRevision or BitbucketSCMSource.MercurialRevision");
    }
