...
public class BitbucketCommitAuthorBranchBuildStrategy extends CommitAuthorBranchBuildStrategy {
    ...
    public BitbucketCommitAuthorBranchBuildStrategy(@CheckForNull String pattern) {
        super(pattern);
    }

    @Override
    public String getAuthor(SCMSource source, SCMHead head, SCMRevision currRevision)
